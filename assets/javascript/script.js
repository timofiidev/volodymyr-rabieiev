...
// Portfolio Pop-up
$(".pop-up-first-portfolio").on("click", function () {
    $(".portfolio-first-overlay").addClass("is-on");
});

$(".close-first-portfolio-popup").on("click", function () {
    $(".portfolio-first-overlay").removeClass("is-on");
});

$(".pop-up-second-portfolio").on("click", function () {
    $(".portfolio-second-overlay").addClass("is-on");
});

$(".close-second-portfolio-popup").on("click", function () {
    $(".portfolio-second-overlay").removeClass("is-on");
});

$(".pop-up-third-portfolio").on("click", function () {
    $(".portfolio-third-overlay").addClass("is-on");
});

$(".close-third-portfolio-popup").on("click", function () {
    $(".portfolio-third-overlay").removeClass("is-on");
});

$(".pop-up-fourth-portfolio").on("click", function () {
    $(".portfolio-fourth-overlay").addClass("is-on");
});

$(".close-fourth-portfolio-popup").on("click", function () {
    $(".portfolio-fourth-overlay").removeClass("is-on");
});

$(".pop-up-fifth-portfolio").on("click", function () {
    $(".portfolio-fifth-overlay").addClass("is-on");
});

$(".close-fifth-portfolio-popup").on("click", function () {
    $(".portfolio-fifth-overlay").removeClass("is-on");
});

$(".pop-up-sixth-portfolio").on("click", function () {
    $(".portfolio-sixth-overlay").addClass("is-on");
});

$(".close-sixth-portfolio-popup").on("click", function () {
    $(".portfolio-sixth-overlay").removeClass("is-on");
});
...
let cursorScale = document.querySelectorAll('a,button,.pop-up,.trigger,.share,.close-portfolio-popup,.toggle,#vimeo,#youtube,.link,.gallery');
let mouseX = 0;
let mouseY = 0;
